<?php get_header(); ?>	
    <section id="articles">
        <div class="boxed masonry">
    		...
    		<?php endwhile; else : ?>
                <p><?php _e("Sorry, we cannot seem to find what you are looking for. Maybe try a different search term.", "refinery"); ?></p>
                <br>
                <p><a class="button" href="javascript:history.back()" title="&laquo; Go Back">&laquo; Go Back</a></p>
    		<?php endif; ?>
        </div>
