...
<div class="page-content">
	bah
	<?php  
	$args = array( 'post_type' => 'music', 'posts_per_page' => 10,  'order' => 'ASC'  );
...
while ( $loop->have_posts() ) : $loop->the_post();
  ...
  $args = array( 'post_type' => 'commercial', 'posts_per_page' => 10,  'order' => 'ASC'  );
$loop = new WP_Query( $args );
while ( $loop->have_posts() ) : $loop->the_post();
	 //$args = array( 'post_type' => 'videos', 'posts_per_page' => 20, 'orderby' => 'date', 'order' => 'ASC' );
        $ytubeID = get_post_meta($post->ID, '_youtubeID', true);
  ...
  $args = array( 'post_type' => 'promo', 'posts_per_page' => 10,  'order' => 'ASC'  );
$loop = new WP_Query( $args );
while ( $loop->have_posts() ) : $loop->the_post();
	 //$args = array( 'post_type' => 'videos', 'posts_per_page' => 20, 'orderby' => 'date', 'order' => 'ASC' );
        $ytubeID = get_post_meta($post->ID, '_youtubeID', true);
...
$args = array( 'post_type' => 'shortFilm', 'posts_per_page' => 10,  'order' => 'ASC'  );
$loop = new WP_Query( $args );
while ( $loop->have_posts() ) : $loop->the_post();
	 //$args = array( 'post_type' => 'videos', 'posts_per_page' => 20, 'orderby' => 'date', 'order' => 'ASC' );
        $ytubeID = get_post_meta($post->ID, '_youtubeID', true);
