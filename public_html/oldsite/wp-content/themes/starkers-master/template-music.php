...
<div class="page-content">
	...
	<?php   
	$loop = new WP_Query( array( 'post_type' => 'music', 'category' => $term, 'post_child' => 0, 'posts_per_page' => 5, 'order' => 'ASC'  ) ); 
 while ( $loop->have_posts() ) : $loop->the_post(); 
        ...
        /* Swapper it out for a quick fix */
        if ($ytubeID || $vimID){
            if ($ytubeID !=""){ // CHECK IF CURRENT POST HAS CATEGORY MUSIC 
                echo '<div class="video"><iframe title="YouTube video player" class="youtube-player" type="text/html" src="http://www.youtube.com/embed/'.$ytubeID.'"  allowfullscreen="true" frameborder="0" width="710" height="460">';
